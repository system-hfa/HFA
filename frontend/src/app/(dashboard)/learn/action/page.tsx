...
const glossary = [
  ...
  { code: 'A-B', name: 'Deslize/lapso/omissão', when: 'Sabia o que fazer mas executou diferente involuntariamente.', example: 'Técnico planejava fechar válvula correta mas operou a adjacente por erro de posição. Piloto planejava acionar sistema A mas acionou B por confusão entre controles similares.', preconditions: 'P1 (fisiológico), P5' },
  ...
  { code: 'A-D', name: 'Inabilidade física', when: 'Limitação física, motora ou de força impediu a execução correta.', example: 'Técnico tentou acionar manivela de emergência mas não teve força para girá-la sob condição de pressão. Piloto tentou corrigir a aeronave mas a força necessária superava sua capacidade física no momento.', preconditions: 'P1 (fisiológico)' },
  { code: 'A-E', name: 'Falha de conhecimento (decisão)', when: 'Não sabia qual ação executar — escolheu por analogia com situação diferente.', example: 'Enfermeiro recém-transferido aplicou protocolo da unidade anterior por desconhecer o procedimento local. Piloto em adaptação executou manobra da aeronave anterior por não conhecer o procedimento correto.', preconditions: 'P6 (treinamento), T1, P7' },
  { code: 'A-F', name: 'Seleção errada (sem pressão)', when: 'Capacidade ok, sem urgência, mas escolheu alternativa errada por viés, hábito ou cálculo inadequado.', example: 'Operador escolheu sequência de desligamento menos segura por hábito, sem urgência — havia alternativa mais conservativa disponível. Piloto que escolheu pousar pelo lado mais arriscado sem pressão de tempo, para validar afirmação anterior.', preconditions: 'P2 (psicológico), P3' },
  ...
  { code: 'A-H', name: 'Gerenciamento de tempo', when: 'Urgência genuína + alocou atenção inadequadamente. Com melhor treinamento, poderia ter gerenciado melhor.', example: 'Técnico que, sob urgência real, priorizou tarefa secundária e não completou a sequência de desligamento correta. Piloto preocupado em localizar plataforma não monitorou instrumentos e desacoplou o automatismo incorretamente.', preconditions: 'T1 (CRM), S3, P5' },
  { code: 'A-I', name: 'Seleção errada (com pressão)', when: 'Sem a pressão de tempo, o operador provavelmente teria escolhido a ação correta.', example: 'Médico que, sob pressão de tempo, administrou medicamento errado ao selecionar opção incorreta na tela de emergência. Piloto que, na urgência, selecionou o procedimento de emergência errado.', preconditions: 'P5, T1' },
