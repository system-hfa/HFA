...
function classifySupportedUses(statement: string, category: SeraFact['category']): SeraEvidenceUse[] {
  ...
  if (/\b(perceiv\w*|notic\w*|recogniz\w*|warning|alert|cue|visual|visibility|cloud|fog|night|instrument|deviation|awareness|information|ambiguous|misleading|did not see|failed to notice|percebeu|perceber|notou|notar|reconheceu|reconhecer|alerta|pista visual|visibilidade|nuvem|nevoeiro|noite|instrumento|desvio|consci[eê]ncia|informa[cç][aã]o|amb[ií]gu[ao]|enganos[ao]|n[aã]o viu|falhou em notar)\b/i.test(statement)) pushUnique(supports, 'PERCEPTION')
