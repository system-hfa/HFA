# A4R186-REAL-TREE-REVIEW-0003 — Real Tree Review

    ## 1. Header
    - reviewId=A4R186-REAL-TREE-REVIEW-0003
    - eventKey=American 1420 LIT
    - sourceExtractionId=A4R180-EXTRACTION-0003
    - approvedEscapePointScope=Continuacao da aproximacao final instavel com perda de referencia visual
    ...
    Continuacao da aproximacao final instavel com perda de referencia visual.

    ## 3. Evidence fragments
    - AA1420-A4R180-F2: Avisos de vento/windshear e informacao operacional disponivel.
- AA1420-A4R180-F3: Perda de referencia visual e cue de sink rate em final.
- AA1420-A4R180-F4: Sequencia tecnica de spoiler no pos-toque tratada como consequencia.
  ...
  evidenceAnchor: AA1420-A4R180-F2/F3/F4
  reasoning: Draft de travessia ancorado apenas em evidencia factual de A4R180-EXTRACTION-0003.
