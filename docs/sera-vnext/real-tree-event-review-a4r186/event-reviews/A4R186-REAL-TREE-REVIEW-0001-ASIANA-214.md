# A4R186-REAL-TREE-REVIEW-0001 — Real Tree Review

    ## 1. Header
    - reviewId=A4R186-REAL-TREE-REVIEW-0001
    - eventKey=Asiana 214 SFO
    - sourceExtractionId=A4R180-EXTRACTION-0001
    - approvedEscapePointScope=Entrada em modo HOLD do autothrottle com inicio de saida do perfil nao percebida pela tripulacao como ator integrado
    ...
    Entrada em modo HOLD do autothrottle com inicio de saida do perfil nao percebida pela tripulacao como ator integrado.

    ## 3. Evidence fragments
    - ASIANA-A4R180-F1: Transicao A/T HOLD e deterioracao de PAPI, velocidade e razao de descida.
- ASIANA-A4R180-F2: Contexto de aproximacao visual com estado A/T HOLD e expectativa operacional.
- ASIANA-A4R180-F3: Reconhecimento tardio e comando de arremetida com margem reduzida.
  ...
  evidenceAnchor: ASIANA-A4R180-F1/F2/F3
  reasoning: Draft de travessia ancorado apenas em evidencia factual de A4R180-EXTRACTION-0001.
