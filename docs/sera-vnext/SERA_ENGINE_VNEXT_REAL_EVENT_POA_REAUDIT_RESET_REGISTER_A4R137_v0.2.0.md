...
|---|---|---|---|---|---|---|
| REAL-EVENT-0003 | AUTHOR_APPROVED_DRAFT_PARTIAL | PARTIAL_REAUDIT_AT_ESCAPE_POINT (A4R139) | Autopilot enrichment (A4R132); A4R130 escape point; A4R133 "Quando..." with autopilot context; A4R139 reaudit | PARTIAL — O-A only (HIGH confidence); P UNRESOLVED; A UNRESOLVED | Reaudited at escape point (A4R139). Escape point = SOURCE_PARTIAL (progressive degradation, not single discrete moment). O-A validated at escape point. P blocked: perception evidence is from after deviation, not at first departure moment. A blocked: actions documented are corrective post-escape, not at escape-point moment. Prior P-G approval NOT reinstated. | P: source enrichment for PF perception at first deviation moment or accept UNRESOLVED. A: PF/PM chain decomposition needed. O-A usable as draft O-axis reference only. |
| REAL-EVENT-0016 | ACTIVE_REVIEW | SOURCE_ENRICHMENT_COMPLETED_PILOT2_CONDITIONAL (A4R141 + A4R141-b) | Batch 2 extraction; A4R130 escape point; A4R104 trace draft; A4R141 GPS/autopilot enrichment; A4R141-b supplemental 89-TXT corpus search addendum | NO | A4R141-b confirmed the A4R141 interpretation/mode-state dominant reading at escape-point timeframe; no local-corpus technical-failure confirmation; residual non-separable mode/action ambiguity remains | Execute Pilot 2 reaudit under A4R138/A4R140 with conditional entry: keep technical failure not supported unless new primary evidence appears; preserve unresolved/block where mode-state/action chain cannot be closed at first departure moment |
