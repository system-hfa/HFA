# QUESTIONPATH-BACKFILL-BATCH2-002
...
- backfillId: QUESTIONPATH-BACKFILL-BATCH2-002
- sourceAdjudicationId: REAL-EVENT-BATCH2-ADJUDICATION-002
...
- questionId: P_INFO_AVAILABLE
  ...
  evidenceRefs:
    ...
    - PF/PM handover and helideck dynamics are not reconciled
  uncertainty: HIGH
...
- questionId: A_SPECIFIC_ACTION_SELECTED_OR_EXECUTED
  ...
  evidenceRefs:
    ...
    - Final PF/PM handover and helideck dynamics are not reconciled
  uncertainty: HIGH
...
- Main uncertainty: Final PF/PM handover and helideck dynamics are not reconciled
...
Enrich PF/PM and final dynamics before any P/A reduction
