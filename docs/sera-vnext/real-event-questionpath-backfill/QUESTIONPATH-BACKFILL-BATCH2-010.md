# QUESTIONPATH-BACKFILL-BATCH2-010
...
- backfillId: QUESTIONPATH-BACKFILL-BATCH2-010
- sourceAdjudicationId: REAL-EVENT-BATCH2-ADJUDICATION-010
...
- questionId: P_INFO_AVAILABLE
  ...
  evidenceRefs:
    ...
    - infrastructure hazard awareness and route alternatives are not sufficiently anchored
  uncertainty: HIGH
...
- Main uncertainty: Infrastructure hazard awareness and route alternatives are not sufficiently anchored
...
Enrich hazard-awareness and taxi-route constraints before any P/A closure
