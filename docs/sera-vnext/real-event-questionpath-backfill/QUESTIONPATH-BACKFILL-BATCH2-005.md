# QUESTIONPATH-BACKFILL-BATCH2-005
...
- backfillId: QUESTIONPATH-BACKFILL-BATCH2-005
- sourceAdjudicationId: REAL-EVENT-BATCH2-ADJUDICATION-005
- sourceExtractionId: A4R72-B2-005
- originalRealEventId: REAL-EVENT-0015
- shortLabel: PH-KHB S-76B dark-night offshore approach water impact
- sourceBatch: BATCH_2_10
- existingP: P-G
- existingO: O-A
- existingA: UNRESOLVED
- existingMaturityStatus: AUTHOR_REVIEW_READY
...
- questionId: P_INFO_AVAILABLE
  ...
  evidenceRefs:
    ...
    - dark-night monitoring evidence supports P-G; callout/input sequence does not isolate A
  uncertainty: MEDIUM/HIGH
  impactOnPath: Supports the existing P-G draft while preserving uncertainty.
...
- questionId: P_PATH_RESULT
  ...
  evidenceRefs:
    ...
    - dark-night monitoring evidence supports P-G; callout/input sequence does not isolate A
  uncertainty: MEDIUM/HIGH
  impactOnPath: Preserves existing P-axis result: P-G. No release or code change.
...
- questionId: A_SPECIFIC_ACTION_SELECTED_OR_EXECUTED
  ...
  evidenceRefs:
    ...
    - Callout/input sequence remains partly reconstructed and does not isolate a specific action mechanism
  uncertainty: MEDIUM/HIGH
...
- Main uncertainty: Callout/input sequence remains partly reconstructed and does not isolate a specific action mechanism
...
## preservedDecisions
- existingP preserved: P-G
- existingO preserved: O-A
- existingA preserved: UNRESOLVED
- existingMaturityStatus preserved: AUTHOR_REVIEW_READY
...
Use as dark-night P/A boundary case; keep A unresolved until sequence is refined
