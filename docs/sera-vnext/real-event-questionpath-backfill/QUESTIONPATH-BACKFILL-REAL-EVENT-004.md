# QUESTIONPATH-BACKFILL-REAL-EVENT-004
...
- questionId: P_INFO_AVAILABLE
  ...
  evidenceRefs:
    ...
    - technical-system degradation dominates; crew diagnostic clarity and action sequence remain unresolved
  uncertainty: HIGH
...
- questionId: A_SPECIFIC_ACTION_SELECTED_OR_EXECUTED
  ...
  evidenceRefs:
    ...
    - Technical-system degradation dominates; crew understanding, checklist sequence, and selected/unavoidable ditching remain unresolved
  uncertainty: HIGH
...
- Main uncertainty: Technical-system degradation dominates; crew understanding, checklist sequence, and selected/unavoidable ditching remain unresolved
...
Keep technical-dominant hold; enrich technical timeline before any P/A closure
