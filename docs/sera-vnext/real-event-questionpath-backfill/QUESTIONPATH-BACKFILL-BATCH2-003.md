# QUESTIONPATH-BACKFILL-BATCH2-003
...
- backfillId: QUESTIONPATH-BACKFILL-BATCH2-003
- sourceAdjudicationId: REAL-EVENT-BATCH2-ADJUDICATION-003
...
- questionId: P_INFO_AVAILABLE
  ...
  evidenceRefs:
    ...
    - repositioning action is known but dynamic limits and inputs are not sufficient for A classification
...
- questionId: A_SPECIFIC_ACTION_SELECTED_OR_EXECUTED
  ...
  evidenceRefs:
    ...
    - Repositioning action is known, but input, wind, deck and dynamic limits are not sufficient for action classification
  uncertainty: MEDIUM/HIGH
...
- Main uncertainty: Repositioning action is known, but input, wind, deck and dynamic limits are not sufficient for action classification
...
Maintain conservative hold and use as action-vs-condition boundary case
