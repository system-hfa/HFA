# QUESTIONPATH-BACKFILL-REAL-EVENT-001
...
- questionId: P_INFO_AVAILABLE
  ...
  evidenceRefs:
    ...
    - state information appears available; low-energy/high-descent-rate response was late; PF/PM action details remain weak
...
- questionId: A_SPECIFIC_ACTION_SELECTED_OR_EXECUTED
  ...
  evidenceRefs:
    ...
    - PF/PM decomposition and action mechanism remain insufficient for A-axis closure
  uncertainty: MEDIUM/HIGH
...
- Main uncertainty: PF/PM decomposition and action mechanism remain insufficient for A-axis closure
...
Use backfilled path for comparison; retain PF/PM and callout enrichment before any action-axis decision
