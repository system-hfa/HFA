# QUESTIONPATH-BACKFILL-BATCH2-008
...
- backfillId: QUESTIONPATH-BACKFILL-BATCH2-008
- sourceAdjudicationId: REAL-EVENT-BATCH2-ADJUDICATION-008
...
- questionId: P_INFO_AVAILABLE
  ...
  evidenceRefs:
    ...
    - technical control-linkage condition dominates; crew response is downstream
...
- questionId: A_SPECIFIC_ACTION_SELECTED_OR_EXECUTED
  ...
  evidenceRefs:
    ...
    - Servo/linkage technical condition dominates; crew response is downstream
  uncertainty: MEDIUM/HIGH
...
- Main uncertainty: Servo/linkage technical condition dominates; crew response is downstream
...
Retain as technical-dominant negative control against forced human attribution
