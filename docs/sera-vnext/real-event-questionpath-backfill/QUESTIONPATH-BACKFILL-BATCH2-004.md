# QUESTIONPATH-BACKFILL-BATCH2-004
...
- backfillId: QUESTIONPATH-BACKFILL-BATCH2-004
- sourceAdjudicationId: REAL-EVENT-BATCH2-ADJUDICATION-004
...
- questionId: P_INFO_AVAILABLE
  ...
  evidenceRefs:
    ...
    - source identity mismatch blocks reliable P/O/A adjudication
  uncertainty: HIGH
...
- Main uncertainty: Source identity mismatch blocks reliable P/O/A adjudication
...
Keep triage-only until source identity is reconciled and re-extracted
