# QUESTIONPATH-BACKFILL-BATCH2-006
...
- backfillId: QUESTIONPATH-BACKFILL-BATCH2-006
...
- questionId: P_INFO_AVAILABLE
  ...
  evidenceRefs:
    ...
    - automation/interface interpretation supports P-C; action mechanism is not separable
  uncertainty: MEDIUM/HIGH
  impactOnPath: Supports the existing P-C draft while preserving uncertainty.
...
- questionId: P_PATH_RESULT
  ...
  evidenceRefs:
    ...
    - automation/interface interpretation supports P-C; action mechanism is not separable
  uncertainty: MEDIUM/HIGH
  impactOnPath: Preserves existing P-axis result: P-C. No release or code change.
...
- questionId: A_SPECIFIC_ACTION_SELECTED_OR_EXECUTED
  ...
  evidenceRefs:
    ...
    - Action mechanism is not separable from automation mode/state perception
  uncertainty: MEDIUM/HIGH
...
- Main uncertainty: Action mechanism is not separable from automation mode/state perception
...
Use as automation perception boundary; keep A unresolved absent a closed control-action chain
