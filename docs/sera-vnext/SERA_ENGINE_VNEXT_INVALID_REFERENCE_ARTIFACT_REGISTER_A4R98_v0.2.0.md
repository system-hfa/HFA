...
|---|---|---|---|---|---|---|
| `docs/sera-vnext/reference-case-traces/REFERENCE-CASE-REAL-EVENT-0003-PG-A4R95.md` | Noncanonical generic question flow (`P1..P5`, `O1..`, `A1..`) instead of exact canonical tree questions. | full artifact | yes | yes | Rebuild in A4+R-100 after A4+R-99 canonical asset pack. | SUPERSEDED / INVALID_FOR_REFERENCE_USE |
| `docs/sera-vnext/SERA_ENGINE_VNEXT_WITHDRAWN_BOUNDARY_REFERENCE_PACK_A4R96_v0.2.0.md` | Summary depends on pre-canonical boundary trace format. | full artifact | yes | yes | Rebuild withdrawn/boundary pack in A4+R-101 with exact canonical tree traversal. | INVALID_FOR_REFERENCE_USE |
| `docs/sera-vnext/reference-case-traces/REFERENCE-CASE-WITHDRAWN-P-AXIS-BOUNDARY-PACK-A4R96.md` | Boundary pack lacks mandatory canonical per-node fields and exact question trace path. | full artifact | yes | yes | Rebuild in A4+R-101 only after A4+R-99 asset pack. | INVALID_FOR_REFERENCE_USE |
| `docs/sera-vnext/real-event-questionpath-backfill/*.md` | Uses auxiliary/synthetic question text (`Was ...`) rather than exact canonical SERA/CERA wording. | family | yes | yes | Replace usage with canonical traces built from A4+R-99 asset pack. | NONCANONICAL_QUESTIONPATH_FAMILY |
