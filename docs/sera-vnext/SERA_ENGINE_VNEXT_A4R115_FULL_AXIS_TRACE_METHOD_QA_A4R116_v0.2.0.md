...
| AMERICAN-1420 | `docs/sera-vnext/reference-case-traces/REFERENCE-CASE-AMERICAN-1420-FULL-AXIS-CANONICAL-DRAFT-A4R115.md` | `docs/sera-vnext/official-report-source-slices/a4r115/SOURCE-SLICE-AMERICAN-1420-A4R115.md` | yes | yes | pass | pass | pass | partial | partial | partial | yes | yes | HIGH | NONE | REVIEW_AFTER_MINOR_FIX | Trace is canonical, but P-D and O-C are the highest-risk branches in the review-eligible set. The O-axis must be framed as an objective/decision issue, not as bad outcome or automatic violation. |
...
## A4R116 QA posture
A4R116 supports keeping three cases as ready for author review (`UPS-1354`, `COLGAN-3407`, `US-AIRWAYS-1549`) and one case as reviewable only after a minor pre-review caution patch (`AMERICAN-1420`). `ASIANA-214` and `AMERICAN-965` should remain outside the author-review approval bundle.
