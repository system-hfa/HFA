...
- **escapePointStatus:** [ DEFINED | UNRESOLVED | SOURCE_PARTIAL | TECHNICAL_FAILURE_NOT_EXCLUDED | DIRECT_ACTOR_UNCLEAR | CONDITION_DOMINANT | MULTI_ACTOR_NOT_DECOMPOSED | POST_ESCAPE_ONLY | WARNING_AS_CONSEQUENCE_ONLY ]
...
- **reAuditDecision:** [ REAUDITED_AT_ESCAPE_POINT_DRAFT | PARTIAL_REAUDIT_AT_ESCAPE_POINT | UNRESOLVED_AT_ESCAPE_POINT | NEEDS_SOURCE_ENRICHMENT | NEEDS_FULL_REBUILD | PARKED | TECHNICAL_FAILURE_DOMINANT | CONDITION_DOMINANT ]
